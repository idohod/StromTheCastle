	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 worldPosValue44_g18 = WorldPosition;
				float3 WorldPosition37_g18 = worldPosValue44_g18;
				float3 worldNormalValue50_g18 = worldNormal85;
				float3 WorldNormal37_g18 = worldNormalValue50_g18;
				float3 localAdditionalLightsLambert37_g18 = AdditionalLightsLambert( WorldPosition37_g18 , WorldNormal37_g18 );
				float3 lambertResult38_g18 = localAdditionalLightsLambert37_g18;
				float3 temp_output_89_0 = lambertResult38_g18;
				...
				float3 Color = ( ( _Dimming * ( ( tex2DNode111 * SampleGradient( gradient117, ( ( (dotResult98*0.26 + 0.5) * max( max( mainLight86 , 0.0 ) , 0.0 ) ) + max( max( break101.x , break101.y ) , break101.z ) ) ) ) + float4( temp_output_89_0 , 0.0 ) ) ) + ( lerpResult109 * smoothstepResult114 * _RimColor * tex2DNode111 ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19001
0;0;2560;1389;1882.879;726.7552;1;True;False
...
WireConnection;165;0;134;0
WireConnection;165;1;118;0
WireConnection;156;2;165;0
ASEEND*/
//CHKSM=4D0EFA3D6DAA868BEC30F621CE5D677F12B50536